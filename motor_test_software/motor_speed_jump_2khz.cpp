/* motor_full_speed.cpp

   David Verdi
   Created 4/5/2017
   Modified 4/6/2017

   This is a test script to turn the motor to high speed using the PIGPIO.
   library.
...
// Sample at a rate of 2 microseconds, PWM of 2 kHz
#define PIN_SAMPLE_TIME 5
...
int main(int argc, char *argv[])
{
  ...
  gpioCfgClock(PIN_SAMPLE_TIME, 1, 1); 
    ...
    // It returns 0 if everything went ok. 
        int half_speed = MAX_DUTY_CYCLE / 2;
	...
	gpioSleep(PI_TIME_RELATIVE, 10, 0);
        ...
        cout << "Activating duty cycle of:" << MAX_DUTY_CYCLE << "\n";
	status_flag = gpioPWM(test_pin, MAX_DUTY_CYCLE);
